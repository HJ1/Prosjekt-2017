...
class BuildExe:
    def __init__(self):
        ...
        #Name of program
        self.project_name = "2017 Project"
        ...
        self.copyright = "Copyright (C) 2017 by HJ."
 
        #Description
        self.project_description = "HJ, Sindre, Tim Prosjekt"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = None
 
        #Extra files/dirs copied to game
        self.extra_datas = ["To do list.txt", "Readme.md", "Gitshell commands tutorial.txt", "setup.py", "data"]
